...
namespace plcdnl\videos\gateways;

use plcdnl\videos\base\Gateway;
use plcdnl\videos\errors\CollectionParsingException;
use plcdnl\videos\errors\VideoNotFoundException;
use plcdnl\videos\helpers\VideosHelper;
use plcdnl\videos\models\Collection;
use plcdnl\videos\models\Section;
...
class Vimeo extends Gateway
{
    ...
    {
        return '@plcdnl/videos/icons/vimeo.svg';
    }
     ...
     */
    public function createOauthProvider(array $options): \Saf33r\OAuth2\Client\Provider\Vimeo
    {
     ...
     * @throws \plcdnl\videos\errors\ApiResponseException
     */
